...
import kotlinx.android.synthetic.main.activity_inspection_set_up.*
import kotlinx.android.synthetic.main.toolbar_with_back_and_save.view.*
import java.util.*

class InspectionSetUpActivity : AppCompatActivity(), InspectionSetUpContract.View {

    override lateinit var presenter: InspectionSetUpContract.Presenter
    override var currentInspection: Inspection? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_inspection_set_up)
        ...
        toolbar.titleToolbar.text = getString(R.string.inspection_set_up)
        InspectionSetUpPresenter(this, inspectionRepo, inspectionId)
    ...
    override fun setUpBackBtnClicked() {
    ...
    override fun setUpOnSaveBtnClicked() {
        toolbar.saveBtn.setOnClickListener {
    ...
    override fun setInspectionFields(inspection: Inspection) {

        inspectionNumEt.setText(inspection.number ?: "")
        inspectorEt.setText(inspection.inspector ?: "")
        titleEt.setText(inspection.title ?: "")

        inspectionEndDateTv.text = inspection.endDate?.toLongCanadianDateString()
        inspectionStartDateTv.text = inspection.startDate?.toLongCanadianDateString()
        linkProjectTv.text = inspection.project
    }
    ...
    override fun showEndDatePicker() {
        val datePickerFragment = DatePickerFragment()
        val bundle = Bundle()
        bundle.putLong(Constants.EXTRA_START_DATE, currentInspection?.startDate?.time ?: 0L)
        datePickerFragment.arguments = bundle
